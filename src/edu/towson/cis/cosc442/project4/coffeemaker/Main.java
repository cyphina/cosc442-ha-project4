...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit" + System.getProperty("line.seperator"));
	...
	public static void addRecipe() {
	    //Read in recipe name
	    String name = inputOutput(System.getProperty("line.seperator") + "Please enter the recipe name: ");
	    
	    //Read in recipe price
	    String priceString = inputOutput(System.getProperty("line.seperator") + "Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    String coffeeString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    String milkString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of sugar in the recipe: ");
	    ...
	    String chocolateString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    String coffeeString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of coffee to add: ");
	    int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    String milkString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of milk to add: ");
	    int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of sugar to add: ");
	    int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt chocolate
	    String chocolateString = inputOutput(System.getProperty("line.seperator") + "Please enter the units of chocolate to add: ");
	    int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
	    	mainMenu();
	    }
    ...
    public static void makeCoffee() {
        ...
        System.out.println("Your change is: " + change + System.getProperty("line.seperator"));
        mainMenu();
    }
    ...
    private static int stringToInt(String value) {
        ...
        try {
            ...
            System.out.println("Please input an integer" + System.getProperty("line.seperator"));
        }
        return returnInt;
    }
    ...
    public static void main(String[] args) {
	    ...
	    System.out.println("Welcome to the CoffeeMaker!" + System.getProperty("line.seperator"));
	    mainMenu();
	}
}
